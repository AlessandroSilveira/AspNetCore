...
.PARAMETER Clean
Removes the image aspnetcore.mvc and kills all containers based on that image.
...
Build a Docker image named aspnetcore.mvc
#>
...
$imageName="aspnetcore.mvc"
$projectName="aspnetcoremvc"
$serviceName="aspnetcore.mvc"
